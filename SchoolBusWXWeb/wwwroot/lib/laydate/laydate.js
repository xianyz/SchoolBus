;!function () {
    ...
    var isLayui = window.layui && layui.define, ready = {
        ...
        ELEM_FOOTER = 'layui-laydate-footer', ELEM_CONFIRM = '.laydate-btns-confirm',
    ...
    */
    ...
    Class.prototype.mark = function (td, YMD) {
        ...
        if (mark === 'primary') {
            td.html('<span class="laydate-day-mark">' + YMD[2] + '</span><span class="date-primary"></span>');
        }
        if (mark === 'success') {
            td.html('<span class="laydate-day-mark">' + YMD[2] + '</span><span class="date-success"></span>');
        }
        if (mark === 'warning') {
            td.html('<span class="laydate-day-mark">' + YMD[2] + '</span><span class="date-warning"></span>');
        }
        if (mark === 'danger') {
            td.html('<span class="laydate-day-mark">' + YMD[2] + '</span><span class="date-danger"></span>');
        }
