...
namespace SchoolBusWXWeb.CommServices
{
    public class LocationService
    {
        public ResponseMessageNews GetResponseMessage(RequestMessageLocation requestMessage)
        {
            ...
            #region 百度地图
            {
                ...
                {
                    Description = $"【来自百度地图】您刚才发送了地理位置信息。Location_X：{requestMessage.Location_X}，Location_Y：{requestMessage.Location_Y}，Scale：{requestMessage.Scale}，标签：{requestMessage.Label}",
                    PicUrl = mapUrl,
                    Title = "定位地点周边地图",
                    Url = mapUrl
                });
            ...
            #region GoogleMap
            {
                ...
                responseMessage.Articles.Add(new Article()
                {
                    Description = $"【来自GoogleMap】您刚才发送了地理位置信息。Location_X：{requestMessage.Location_X}，Location_Y：{requestMessage.Location_Y}，Scale：{requestMessage.Scale}，标签：{requestMessage.Label}",
                    PicUrl = mapUrl,
                    Title = "定位地点周边地图",
                    Url = mapUrl
                });
